...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        Log.d("TEST", "onActivityResult: " + requestCode + " " + resultCode + " " + RESULT_OK + " " + RESULT_CANCELED);
    ...
    public static class RefreshTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPostExecute(final String result) {
            ...
            if (result.equalsIgnoreCase(context.getString(R.string.result_error))) {
                showAlertDialog(context, "การเชื่อมต่อผิดพลาด", "ไม่สามารถดาวน์โหลดข้อมูลได้ กรุณาลองใหม่ภายหลัง");
