 ...
 */
public class DocheaderPage extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        url = sp.getString("DOCHEADER_URL", "");
        fileUrl = url.substring(40);
        File pdfFile = new File(Environment.getExternalStorageDirectory() + "/TMS_HEADER/" + fileUrl);
    ...
    private class DownloadFile extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... strings) {
            ...
            File folder = new File(extStorageDirectory, "/TMS_HEADER/");
            folder.mkdir();
